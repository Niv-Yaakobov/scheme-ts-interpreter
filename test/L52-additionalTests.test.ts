...
describe('L52 Test of isSubType', () => {
    ...
    it('Basic type predicate test3', () => {
        //console.log("number union(str U num)\n");
        const te1 = `number`;
    ...
    it('Basic type predicate test4', () => {
        //console.log("union(str num bool) union(str num)\n");
    ...
    it('Basic type predicate test5', () => {
        //console.log("inter(any num) union(str num bool)\n");
    ...
    it('Basic type predicate test6', () => {
        //console.log("inter(union(str bool)) bool\n");
